...
// 普通中间件签名，与 Express 的 handler 类似
export type RequestHandler = (req: Request, res: ServerResponse, next: (err?: Error) => void) => void | Promise<void>;

// 错误处理中间件签名：多一个 err 参数
export type ErrorHandler = (err: Error, req: Request, res: ServerResponse, next: (err?: Error) => void) => void;
